...
const NOTE: &str = "# This file was generated by [py-rs](https://github.com/Blue-Chestnut/py-rs). Do not edit this file manually.\nfrom pydantic import BaseModel\nfrom enum import Enum\n\n";
...
fn export_and_merge(
    ...
    let lock_result = EXPORT_PATHS.lock();
    if lock_result.is_err() {
        print!("result {:?}", lock_result.err());
        return Err(ExportError::CannotBeExported(""));
    }
